...
//if (!in_array($size, array('babu', 'nyanya', 'dada', 'kaka', 'shangazi', 'mjomba')))
//

$user = elgg_extract('entity', $vars, elgg_get_logged_in_user_entity());
$size = elgg_extract('size', $vars, 'kaka');
if (!in_array($size, array('babu', 'nyanya', 'dada', 'kaka', 'shangazi', 'mjomba'))) {
$size = 'medium';
}

$class = "elgg-timlineavatar elgg-timlineavatar-$size";
if (isset($vars['class'])) {
...
$icontime = $user->coverphototime; //TM:  coverphototime
if (!$icontime) {
$icontime = "default";
}
...
$icon_url = elgg_format_url($user->getTimelineiconURL($size));
