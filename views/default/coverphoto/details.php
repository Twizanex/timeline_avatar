...
echo '<div id="coverphoto-details" class="elgg-body pll">';
...
<b><?php echo elgg_echo("coverphoto:{$shortname}"); ?>: </b>
<?php
...
if ($user->isBanned()) {
echo "<p class='coverphoto-banned-user'>";
echo elgg_echo('banned');
echo "</p>";
} else {
if ($user->description) {
echo "<p class='coverphoto-aboutme-title'><b>" . elgg_echo("coverphoto:aboutme") . "</b></p>";
echo "<div class='coverphoto-aboutme-contents'>";
