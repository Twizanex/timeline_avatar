<?php
/**
* Elgg coverphoto timelineicon cache/bypass
*
*
* @package ElggProfile
*/
...
$last_cache = (int)$_GET['lastcache']; // timelinetime
$guid = (int)$_GET['guid'];
...
if (!in_array($size, array('shangazi', 'kaka', 'dada', 'nyanya', 'mjomba', 'babu'))) {
$size = "kaka";
}
...
$filename = "$data_root$user_path/coverphoto/{$guid}{$size}.jpg";
...
forward("mod/timeline_avatar/graphics/timelineicons/user/default{$size}.gif");