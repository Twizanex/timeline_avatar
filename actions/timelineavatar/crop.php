...
register_error(elgg_echo('timlineavatar:crop:fail')); //TM:  timlineavatar
forward(REFERER);
}
...
$filehandler->setFilename("coverphoto/" . $owner->guid . "master" . ".jpg"); //TM:  coverphoto 
...
$icon_sizes = elgg_get_config('coverphoto_sizes'); //TM:  to coverphoto_sizes 
unset($icon_sizes['mjomba']);
...
system_message(elgg_echo('timlineavatar:crop:success')); //TM:  timlineavatar
